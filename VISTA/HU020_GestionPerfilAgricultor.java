...
import vista.HU001_GestionCatalogoAgricultor;
import vista.HU004_AutenticacionUsuario;
import vista.HU024_InicioAgricultor;
import javax.swing.ImageIcon;


public class HU020_GestionPerfilAgricultor extends javax.swing.JFrame {
    
    private int idUsuarioBD;
    private String nombreUsuarioBD;
    private boolean passwordVisible = false;
    private control.Controlador_HU020_GestionPerfilAgricultor controlador; // <-- nuevo

    
    public HU020_GestionPerfilAgricultor(int idUsuarioBD) {
        initComponents();
        this.idUsuarioBD = idUsuarioBD;
        this.setLocationRelativeTo(null);
        txtContrasena.setEchoChar('*'); // Asegura que se vean los ***
        lblVerContrasena.setIcon(new ImageIcon(getClass().getResource("/img/ojo_cerrado.png")));
        
        this.controlador = new control.Controlador_HU020_GestionPerfilAgricultor(this, idUsuarioBD);
        this.controlador.cargarPerfil();
    }
    
    public HU020_GestionPerfilAgricultor() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel24.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/Usuario.png"))); // NOI18N
        ...
        lblActualizarPerfil.setText("Actualizar Perfil");
        ...
        jPanel12Layout.setHorizontalGroup(
            ...
            .addComponent(lblActualizarPerfil, javax.swing.GroupLayout.DEFAULT_SIZE, 98, Short.MAX_VALUE)
        );
        jPanel12Layout.setVerticalGroup(
            jPanel12Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(lblActualizarPerfil, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 31, Short.MAX_VALUE)
        );
                ...
                .addGroup(jPanel8Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel8Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel8Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(lblVerContrasena, javax.swing.GroupLayout.DEFAULT_SIZE, 30, Short.MAX_VALUE))
                        .addGap(85, 85, 85))
                    .addGroup(jPanel8Layout.createSequentialGroup()
                        .addGap(1, 1, 1)
                        .addComponent(jLabel24, javax.swing.GroupLayout.PREFERRED_SIZE, 130, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void lblActualizarPerfilMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblActualizarPerfilMouseClicked
        new HU022_ActualizarPerfil(idUsuarioBD, "Agricultor").setVisible(true);
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(HU020_GestionPerfilAgricultor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new HU020_GestionPerfilAgricultor().setVisible(true);
            }
        });
    }
