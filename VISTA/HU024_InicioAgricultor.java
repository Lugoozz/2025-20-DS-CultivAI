...
public class HU024_InicioAgricultor extends javax.swing.JFrame {
    private int idUsuarioBD;
    private String nombreUsuarioBD;

    public HU024_InicioAgricultor(int idUsuarioBD) {
        initComponents();
        this.idUsuarioBD = idUsuarioBD;
        this.setLocationRelativeTo(null);
    }
    
    public HU024_InicioAgricultor() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel12.add(jLabel14, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 140, 540, -1));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(HU024_InicioAgricultor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new HU024_InicioAgricultor().setVisible(true);
            }
        });
    }
